...
use crate::data::{Allocation, AllocationId, DataPointer, Timestamp};
    ...
    K: PartialEq + Clone,
{
        ...
        T: Iterator<Item = (K, V)>,
    {
        ...
        self.allocations
            .insert(allocation.pointer, (node_id, index));
